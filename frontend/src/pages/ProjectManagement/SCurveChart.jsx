...
//
// import CSS ของตัวเอง (ไม่พึ่ง CSS ของหน้าที่เรียกใช้) — สำคัญมาก: component นี้ถูกเรียกใช้จากหลายหน้าที่
// แยก code-split กันคนละ chunk (ProjectManagement, ForemanSCurveTab, ClientSCurveTab, ClientReportTab)
// ถ้า CSS อยู่ปนกับไฟล์ของหน้าใดหน้าหนึ่ง หน้าอื่นที่เรียกใช้ component นี้จะไม่ได้ style เลย (เจอบั๊กนี้มา
// แล้วจริง — กราฟกลายเป็นแท่งดำทึบเพราะ SVG ใช้ fill สีดำเป็นค่า default เมื่อไม่มี CSS กำหนด)
