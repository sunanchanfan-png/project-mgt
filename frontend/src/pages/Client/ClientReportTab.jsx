...
<body>
  ...
  return (
    <div className="progress-table-wrap">
      {(report?.schedule_pdf_url || reportId) && (
      ...
      {report?.schedule_pdf_url && showSchedule && (
